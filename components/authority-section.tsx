...
import { FadeUp, StaggeredText } from "@/components/staggered-text"
...
export function AuthoritySection() {
  ...
  return (
    <section id="authority" className="px-6 md:px-12 lg:px-20 py-24 md:py-40">
      ...
      <FadeUp delay={0.15}>
        <div
          className="group relative bg-card p-8 md:p-12 lg:p-16 transition-colors duration-500 hover:bg-secondary"
          data-hover
        >
      ...
      <div ref={credRef} className="grid grid-cols-1 md:grid-cols-3 gap-px mt-px bg-border">
        {[
          ...
          <motion.div
            key={item.label}
            className="bg-background p-8 md:p-12 text-center transition-colors duration-500 hover:bg-card"
